function [scores, meanIX, perTrackScores, tAIX, metricLabels] = calcAllMetricsFigMatch(expN)
    ...
    timeStart = 60;
    gatePosition = calcZone; upLaser = true;
    ...
    timeStart = 60;
    gatePosition = calcZone; upLaser = false;
    [gIX, stSamp] = gateFlashEncounterByDirection(tA, tAIX, timeStart, gatePosition, upLaser);
    calcFcn = @fcnCosHeadAngle;
    stSamp = stSamp + round(.5/.05);
    enSamp = stSamp + round(.5/.05);
